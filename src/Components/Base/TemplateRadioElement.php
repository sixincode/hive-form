...
class TemplateRadioElement extends Component
{
    ...
    public function __construct(
      ...
      $this->makeRadios($radios);
      $this->renderViewSettings();
    }

    public function makeRadios($radios){
      foreach ($radios as $key => $radio) {
        $this->radios[Str::snake(strtolower($radio[0]))] = $radio;
      }

      if(! $this->default){
        $this->default = array_key_first($this->radios);
      }
    }
